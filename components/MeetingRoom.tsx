...
type TCallLayoutType = 'grid' | 'speaker-left' | 'speaker-right'

const MeetingRoom = () => {
  const searchParams = useSearchParams();
  const isPersonalRoom = !!searchParams.get('personal');
  const [layout, setLayout] = useState<TCallLayoutType>('speaker-left');
              ...
              map((item, index) =>
                <div key={index}>
                  <DropdownMenuItem
                    ...
                    onClick={() => {
                      setLayout(item.toLocaleLowerCase() as TCallLayoutType)
                    }}
                  >
                    {item}
                  </DropdownMenuItem>
